      ...
      (is (= (-> result (first) (:result))
             [{:resourceType "Account"
              ...
              {:resourceType "Account"
               ...
               :name "Account 4"
               :info "No profile, No Posts, No Comments"}]))))
  (testing "050 It returns correct result for 4-level resource tree with multiple referenced resources"
    (let [resource
          {:resourceType "Account"
           :references
      ...
      (is (= (-> result (first) (:result))
             [{:resourceType "Account"
               :id "account-1"
               :name "Account 1"
               :profile {:resourceType "Profile" :id "profile-1" :enabled false :other "foo"}
               :posts
               [{:resourceType "Post"
                 :id "post-1"
                 :author {:id "account-1"}
              ...
              {:resourceType "Account"
               :id "account-2"
               :name "Account 2"
               :profile {:resourceType "Profile" :id "profile-2" :enabled true :other "bar"}
               :posts
               [{:resourceType "Post"
                 :id "post-3"
                 :author {:id "account-2"}
